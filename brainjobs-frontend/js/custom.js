const API = "http://localhost:8082/brainjobs-gateway/api/v1/users/";
...
$(document).ready(function() {
    ...
    $("#get-all-requests").click(function(e){
        ...
        $.ajax({
            ...
            type: "GET",
            url: 'http://localhost:8082/brainjobs-gateway/api/v1/jobs',
            dataType: "json",
    ...
    $("#get-single-request").click(function(e){
        ...
        $.ajax({
            ...
            type: "GET",
            url: 'http://localhost:8082/brainjobs-gateway/api/v1/jobs/' + $("#job_id").val(),
            dataType: "json",
            success: function(data) {
